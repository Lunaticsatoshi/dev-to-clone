...
urlpatterns = [
    ...
    path('user/<str:id>/update/', UserArticleUpdateApiView.as_view(), name='user-article-update'),
    path('user/<str:id>/delete/', UserArticleDeleteApiView.as_view(), name='user-article-delete'),
